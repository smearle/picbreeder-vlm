...
def main() -> None:
    fer_root = Path(__file__).resolve().parents[1]
    pb_dir = (fer_root / "spaghetti/pbRender/genomeAll").resolve()
    # image_dir = (fer_root / "src/archive_res-128").resolve()
    # Use res-224 for better quality if available, else 128
    image_dir = (fer_root / "src/archive_res-224").resolve()
