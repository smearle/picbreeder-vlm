...
public class AddAcyclicLinkBetweenAffinities extends AbstractMutator {
	private final String from, to;
	
	public AddAcyclicLinkBetweenAffinities(String sourceAffinity, String destinationAffinity) {
		from = sourceAffinity;
		to = destinationAffinity;
	}
