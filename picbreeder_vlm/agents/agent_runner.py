...
from picbreeder_vlm.core.archive_manager import ARCHIVE_GRID_MARGIN, ArchiveEntry, ArchiveManager
from picbreeder_vlm.core.artifacts import render_genome_images, save_neat_genome_diagrams
from picbreeder_vlm.vlm.chat import GeminiPromptBlockedError, extract_json_object, query_with_history, reset_chat_session, restore_chat_history_from_metadata, select_parents_from_grid, summarize_genome_structure
from picbreeder_vlm.core.config import PicbreederConfig
from picbreeder_vlm.core.constants import DEFAULT_BASELINE_SELECTION_LIMIT, REPO_ROOT

# Module-level cache so CLIP noun embeddings are computed once per process
_CLIP_NOUN_CACHE: Dict[str, Any] = {}
from picbreeder_vlm.core.neat_components import GenerationCheckpointer, LATEST_POPULATION_FILENAME, seed_initial_population, sync_population_node_indexer, sync_population_output_activations
from picbreeder_vlm.vlm.prompts import ARCHIVE_BRANCHING_PROMPT, ARCHIVE_NOVELTY_PROMPT, COLOR_PROMPT, GOAL_PROMPTS, MUTATION_STRENGTH_PROMPT, PARENT_SELECTION_PROMPT, DEFAULT_SYSTEM_INSTRUCTION, FIXED_SESSION_SYSTEM_INSTRUCTION, gen_selection_prompt
from picbreeder_vlm.core.rendering import _draw_dotted_rectangle, create_numbered_grid
from picbreeder_vlm.core.utils import _ensure_int_list, relative_suffix_after_dir, resolve_nounlist
