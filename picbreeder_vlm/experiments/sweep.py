...
from picbreeder_vlm.agents.collaborative_multi_agent import run as run_collaborative
from picbreeder_vlm.core.config import PicbreederConfig, ensure_valid_config
from picbreeder_vlm.experiments.sweep_configs import _NAMED_SWEEPS, RandBaselineSweep, SweepConfig
from picbreeder_vlm.core.utils import resolve_nounlist
from picbreeder_vlm.experiments.sweep_analysis_utils import (
...
def _run_eval_tree(cfg: SweepConfig, run_configs: Sequence[PicbreederConfig], original_cwd: Path, cross_eval_dir: Path, filename_tag: str):
    ...
    from pathlib import Path
    from dataclasses import fields as dataclass_fields, replace
    from picbreeder_vlm.viz.visualize_archive_phylogeny import ArchivePhylogenyConfig, main as viz_main
    from picbreeder_vlm.core.config import PicbreederConfig
...
def main(cfg: SweepConfig) -> None:
    ...
    if cfg.cross_eval:
        from picbreeder_vlm.viz.render_embedding_metrics_table import DEFAULT_METRICS_FILENAME, render_tables
