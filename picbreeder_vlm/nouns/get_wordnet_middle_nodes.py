...
wnids_path = "data/noun_lists/imagenet21k_wordnet_ids.txt"
...
with open("data/noun_lists/imagenet21k_all_words.txt", "w") as f:
...
with open("data/noun_lists/imagenet21k_middle_wnids.txt", "w") as f:
    f.write("\n".join(middle_wnids) + "\n")

with open("data/noun_lists/imagenet21k_middle_words.txt", "w") as f:
    f.write("\n".join(middle_words) + "\n")