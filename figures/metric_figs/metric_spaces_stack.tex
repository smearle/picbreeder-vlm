...
\IfFileExists{_recall_meta.tex}{\input{_recall_meta.tex}}{%
...
\node[frame, minimum width=4.2cm, minimum height=4.2cm, anchor=north west]
  (arch) at (0,-2.4) {\includegraphics[width=3.6cm]{archive_grid.png}};
...
\node[anchor=north] (rP) at (\Cx,\Ry) {\includegraphics[width=\PW]{recall_iso.png}};
\node[anchor=north] (sP) at (\Cx,\Sy) {\includegraphics[width=\PW]{semantic_iso.png}};
\node[anchor=north] (vP) at (\Cx,\Vy) {\includegraphics[width=\PW]{visual_iso.png}};
...
\node[plabel] (vt) at (\Lx,0 |- vW)
  {\textbf{\textcolor{visAcc}{Visual Coverage}}};
\node[chip] at ([yshift=-0.15cm]vt.south west) {$k$-covering radius};

\node[plabel] (st) at (\Lx,0 |- sW)
  {\textbf{\textcolor{semAcc}{Semantic Coverage}}};
\node[chip] at ([yshift=-0.15cm]st.south west) {$k$-covering radius};

\node[plabel] (rt) at (\Lx,0 |- rW)
  {\textbf{\textcolor{recAcc}{Semantic Recall}}};
\node[chip] at ([yshift=-0.15cm]rt.south west) {mean distance of nearest\\ image over all nouns};
