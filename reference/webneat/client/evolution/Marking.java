...
/**
 * A Marking keeps track of the branch and id number of a gene in a genome.
 * It differs from a Identifer in that a identifier is per genome, where the
 * Marking is per gene.
 * 
 * @author Nick Beato
 */

public interface Marking extends Transferable, Comparable <Marking> {
	/**
