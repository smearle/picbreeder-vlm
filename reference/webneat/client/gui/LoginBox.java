...
public class LoginBox extends JDialog {
	...
	private JButton anonymousButton = null;
	
	private boolean anonymousPressed = false;
	...
	private void initialize() {
		this.setSize(305, 155);
		
		java.awt.Container p = getParent(); 
		int x = p.getX() + (p.getWidth() - this.getWidth()) / 2;
		int y = p.getY() + (p.getHeight() - this.getHeight()) / 2;
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			GridBagConstraints gridBagConstraintsAnon = new GridBagConstraints();
			gridBagConstraintsAnon.gridx=0;
			gridBagConstraintsAnon.gridy=3;
			gridBagConstraintsAnon.gridwidth = 5;
			gridBagConstraintsAnon.gridheight = 1;
			gridBagConstraintsAnon.anchor=GridBagConstraints.CENTER;
			gridBagConstraintsAnon.fill=GridBagConstraints.BOTH;
			...
			jContentPane.add(getAnonymousButton(),gridBagConstraintsAnon);
		}
		return jContentPane;
	}
	...
	private JButton getCancelButton() {
		if (cancelButton == null) {
			...
			cancelButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					loginPressed = registerPressed = anonymousPressed = false;
					setVisible(false);
				}
			});
		}
	...
	private JButton getAnonymousButton() {
		if (anonymousButton == null) {
			anonymousButton = new JButton();
			anonymousButton.setText("Publish Anonymously");
			anonymousButton.setMnemonic('A');
			anonymousButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					anonymousPressed = true;
					setVisible(false);
				}
			});
		}
