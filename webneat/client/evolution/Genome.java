...
public interface Genome extends Transferable, Cloneable, Comparable <Genome> {
	/**
	 * Determines whether or not this genome was saved in color or greyscale.
	 * <p>
	 * The interpretation is interfaced as an int since the rest of the system
	 * only cares about which phenotype index to use.
	 * 
	 * @return 0 for "structure" or 1 for "color"
	 */
	public int getDominantPhenotype();

	/**
	 * Sets whether or not this genome is color or greyscale.
	 * <p>
	 * The interpretation is interfaced as an int since the rest of the system
	 * only cares about which phenotype index to use.
	 * 
	 * @param index 0 for "structure" or 1 for "color"
	 */
	...
	/**
	 * Forces the age to be equivalent to its parent. 
	 */
