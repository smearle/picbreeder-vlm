...
public interface GeneticFactory {
	/**
	 * Changes the generator scheme.
	 * 
	 * @param name The new scheme
	 */
	public void setScheme(String name);
	
	/**
	 * Changes the mutation slider thingy.
	 * 
	 * @param coefficient The value
	 */
	public void setSliderCoeffecient(double coeffecient);
	
	/**
	 * Hack to update a genome to color... should have used "loadGenome" over
	 * "createInvalidGenome"... oh well. This will take any genome and make sure
	 * it can render in color.
	 * 
	 * @param genome The parent
	 * @return Converted color genome
	 */
	 ...
	 * @param affinity The affinity of the node
	 * @return The node
	 */
	 ...
	 * @return The node
	 */
	public Node createNode(String label, String type, String affinity);
