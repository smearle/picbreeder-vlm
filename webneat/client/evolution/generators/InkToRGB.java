...
public class InkToRGB extends AbstractMutator {
	public void mutate(Genome g) {
		...
		Node red = GeneticFactoryInstance.get().createNode("red", "out", "color");
		Node green = GeneticFactoryInstance.get().createNode("green", "out", "color");
		Node blue = GeneticFactoryInstance.get().createNode("blue", "out", "color");
